...
from model import SimpleNet, SimpleNet2, ResidualDiffusionModel1D
import torch
import numpy as np
...
# Run the comparison
# -------------------------
#model_baseline = SimpleNet2(input_dim=1, hidden_dim=512, time_embed_dim=512)
model_baseline = ResidualDiffusionModel1D(1, 1024, 1024, 15)
model_baseline.cuda()
